...
1. the `type` field of the block MUST be set to `"37appr"`
2. the `tx` field
...
1. the `type` field of the block MUST be set to `"37appr_coll"`
2. the `tx` field
...
1. the `type` field of the block MUST be set to `"37revoke"`
2. the `tx` field
...
1. the `type` field of the block MUST be set to `"37revoke_coll"`
2. the `tx` field
...
1. the `type` field of the block MUST be set to `"37xfer"`
2. the `tx` field
